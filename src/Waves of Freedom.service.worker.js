...
/** @type {string} */
const CACHE_VERSION = '1772480948|1616217535';
/** @type {string} */
const CACHE_PREFIX = 'Gamejam-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Waves of Freedom.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Waves of Freedom.html","Waves of Freedom.js","Waves of Freedom.offline.html","Waves of Freedom.icon.png","Waves of Freedom.apple-touch-icon.png","Waves of Freedom.audio.worklet.js","Waves of Freedom.audio.position.worklet.js","pako_inflate.min.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Waves of Freedom.wasm","Waves of Freedom.pck"];
